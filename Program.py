...
class TestApp(TestWrapper, TestClient):
    ...
    def reqHistoricalDataUS(self, ticker):
    ...
    @printWhenExecuting
    def optionsOperations_req(self, ticker):
        # ! [reqsecdefoptparams]
        self.reqSecDefOptParams(0, ticker, "", "STK", 8314)
        # ! [reqsecdefoptparams]
    ...
    #@printWhenExecuting
    def getMktData(self, ticker):
        contract = ContractSamples.USStockAtSmart()
        contract.symbol = ticker
        self.reqMktData(10001, contract, "mdoff,292", False, False, []);
...
#              "Projection:", projection, "Legs String:", legsStr)
    ...
    def orderOperations_req(self):
        ...
        self.placeOrder(self.last_order_id, ContractSamples.USStock(),
...
######################################
    #@printWhenExecuting
    def reqNewBuyOrder(self, ticker, quantity, limit_price=None):
        # Requesting the next valid id
        # The parameter is always ignored.
        self.reqIds(-1)
